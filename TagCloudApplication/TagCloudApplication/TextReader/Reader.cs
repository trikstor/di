...
namespace TextReader
{
    public class Reader : IReader
    {
        ...
        public Dictionary<string, int> Read(string path)
        {
            ...
            CheckFilePathAndNameExtention(path, currNameExtention, nameExtensions);
        ...
        private void CheckFilePathAndNameExtention(string path, string extension, IEnumerable<string> nameExtensions)
        {
            if(!nameExtensions.Any(extension.IsSameOrEqualTo))
